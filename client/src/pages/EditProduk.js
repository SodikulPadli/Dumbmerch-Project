          ...
          <Col xs="12">
            <form onSubmit={(e) => handleSubmit.mutate(e)}>
              <div className="d-grid">
                ...
                <br />
                <input type="text" placeholder="Product Name" name="name" onChange={handleChange} value={form?.name} className="input-edit-category mt-4" /> <br />
                ...
                <br />
                <input type="number" placeholder="Stock" name="stock" onChange={handleChange} value={form?.stock} className="input-edit-category mt-4" />
                <br />
