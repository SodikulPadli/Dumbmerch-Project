...
export default function DetailProduk() {
  ...
  return (
    <div className="bg-black">
      <Navbar />
      <Container className="py-5 my-5 vh-100">
        <Row style={{ color: 'white' }}>
          ...
          <Col md="5">
            ...
            <div className="text-end mt-4 fw-bold"> {convertRupiah.convert(product?.price)}</div>
            <div className="d-grid gap-2 mt-5">
              <button onClick={() => handleBuy.mutate()} className="btn btn-danger">
                Buy
              </button>
            </div>
          </Col>
